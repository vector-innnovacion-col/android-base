...
public class DemoConfiguration {
    ...
    static {
        ...
        addDemoFeature("cloud_logic_apis", R.mipmap.cloud_logic_apis, R.string.feature_cloud_logic_apis_title,
                R.string.feature_cloud_logic_apis_subtitle, R.string.feature_cloud_logic_apis_overview,
