...
public class DemoNoSQLTableMember extends DemoNoSQLTableBase {
    private static final String LOG_TAG = DemoNoSQLTableMember.class.getSimpleName();
    ...
    public class DemoGetWithPartitionKeyAndSortKey extends DemoNoSQLOperationBase {
        ...
        public boolean executeOperation() {
            ...
            result = mapper.load(MemberDO.class, AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID(), "demo-email-500000");
        ...
        public List<DemoNoSQLResult> getNextResultGroup() {
            ...
            results.add(new DemoNoSQLMemberResult(result));
    ...
    public class DemoQueryWithPartitionKeyAndSortKeyCondition extends DemoNoSQLOperationBase {
        ...
        private PaginatedQueryList<MemberDO> results;
        private Iterator<MemberDO> resultsIterator;
        ...
        @Override
        public boolean executeOperation() {
            final MemberDO itemToFind = new MemberDO();
            ...
            final DynamoDBQueryExpression<MemberDO> queryExpression = new DynamoDBQueryExpression<MemberDO>()
                .withHashKeyValues(itemToFind)
                .withRangeKeyCondition("email", rangeKeyCondition)
                .withConsistentRead(false)
                .withLimit(RESULTS_PER_RESULT_GROUP);

            results = mapper.query(MemberDO.class, queryExpression);
            if (results != null) {
    ...
    public class DemoQueryWithPartitionKeyAndFilter extends DemoNoSQLOperationBase {
        ...
        DemoQueryWithPartitionKeyAndFilter(final Context context) {
            super(context.getString(R.string.nosql_operation_title_query_by_partition_and_filter_text),
                  String.format(context.getString(R.string.nosql_operation_example_query_by_partition_and_filter_text),
                      "userId", AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID(),
                      "birth-date", "demo-birth-date-500000"));
        }
        ...
        public boolean executeOperation() {
            ...
            filterExpressionAttributeNames.put("#birth-date", "birth-date");

            final Map<String, AttributeValue> filterExpressionAttributeValues = new HashMap<>();
            filterExpressionAttributeValues.put(":Minbirth-date",
                new AttributeValue().withS("demo-birth-date-500000"));

            final DynamoDBQueryExpression<MemberDO> queryExpression = new DynamoDBQueryExpression<MemberDO>()
                .withHashKeyValues(itemToFind)
                .withFilterExpression("#birth-date > :Minbirth-date")
    ...
    public class DemoScanWithFilter extends DemoNoSQLOperationBase {
        ...
        private PaginatedScanList<MemberDO> results;
        private Iterator<MemberDO> resultsIterator;
        ...
        public boolean executeOperation() {
            ...
            results = mapper.scan(MemberDO.class, scanExpression);
            if (results != null) {
                resultsIterator = results.iterator();
                if (resultsIterator.hasNext()) {
                    return true;
     ...
     */
    private static List<DemoNoSQLResult> getNextResultsGroupFromIterator(final Iterator<MemberDO> resultsIterator) {
        if (!resultsIterator.hasNext()) {
            return null;
        }
        ...
        do {
            ...
            final MemberDO item = resultsIterator.next();
            // Add the item to a group of results that will be displayed later.
            resultGroup.add(new DemoNoSQLMemberResult(item));
            itemsRetrieved++;
    ...
    public void insertSampleData() throws AmazonClientException {
        ...
        final MemberDO firstItem = new MemberDO();

        firstItem.setUserId(AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID());
        firstItem.setEmail("demo-email-500000");
        firstItem.setBirthDate(
            DemoSampleDataGenerator.getRandomSampleString("birth-date"));
        ...
        firstItem.setNickName(
            DemoSampleDataGenerator.getRandomSampleString("nick-name"));
        ...
        final MemberDO[] items = new MemberDO[SAMPLE_DATA_ENTRIES_PER_INSERT-1];
        for (int count = 0; count < SAMPLE_DATA_ENTRIES_PER_INSERT-1; count++) {
            final MemberDO item = new MemberDO();
            ...
            item.setBirthDate(DemoSampleDataGenerator.getRandomSampleString("birth-date"));
            ...
            item.setNickName(DemoSampleDataGenerator.getRandomSampleString("nick-name"));
    ...
    public void removeSampleData() throws AmazonClientException {
        ...
        final PaginatedQueryList<MemberDO> results = mapper.query(MemberDO.class, queryExpression);

        Iterator<MemberDO> resultsIterator = results.iterator();
        ...
        final List<MemberDO> batchOfItems = new LinkedList<MemberDO>();
