...
public class DemoNoSQLTableRankingByUser extends DemoNoSQLTableBase {
    private static final String LOG_TAG = DemoNoSQLTableRankingByUser.class.getSimpleName();
    ...
    public class DemoGetWithPartitionKeyAndSortKey extends DemoNoSQLOperationBase {
        private RankingByUserDO result;
        ...
        public boolean executeOperation() {
            ...
            result = mapper.load(RankingByUserDO.class, AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID(), 1111500000.0);
        ...
        public List<DemoNoSQLResult> getNextResultGroup() {
            ...
            results.add(new DemoNoSQLRankingByUserResult(result));
    ...
    public class DemoQueryWithPartitionKeyAndSortKeyCondition extends DemoNoSQLOperationBase {
        ...
        private PaginatedQueryList<RankingByUserDO> results;
        private Iterator<RankingByUserDO> resultsIterator;
        ...
        @Override
        public boolean executeOperation() {
            final RankingByUserDO itemToFind = new RankingByUserDO();
            ...
            final DynamoDBQueryExpression<RankingByUserDO> queryExpression = new DynamoDBQueryExpression<RankingByUserDO>()
                .withHashKeyValues(itemToFind)
                .withRangeKeyCondition("points", rangeKeyCondition)
                .withConsistentRead(false)
                .withLimit(RESULTS_PER_RESULT_GROUP);

            results = mapper.query(RankingByUserDO.class, queryExpression);
            if (results != null) {
    ...
    public class DemoScanWithoutFilter extends DemoNoSQLOperationBase {
        ...
        private PaginatedScanList<RankingByUserDO> results;
        private Iterator<RankingByUserDO> resultsIterator;
        ...
        public boolean executeOperation() {
            ...
            results = mapper.scan(RankingByUserDO.class, scanExpression);
            if (results != null) {
                resultsIterator = results.iterator();
                if (resultsIterator.hasNext()) {
                    return true;
     ...
     */
    private static List<DemoNoSQLResult> getNextResultsGroupFromIterator(final Iterator<RankingByUserDO> resultsIterator) {
        if (!resultsIterator.hasNext()) {
            return null;
        }
        ...
        do {
            ...
            final RankingByUserDO item = resultsIterator.next();
            // Add the item to a group of results that will be displayed later.
            resultGroup.add(new DemoNoSQLRankingByUserResult(item));
            itemsRetrieved++;
    ...
    public DemoNoSQLTableRankingByUser() {
    ...
    public void insertSampleData() throws AmazonClientException {
        ...
        final RankingByUserDO firstItem = new RankingByUserDO();

        firstItem.setUserId(AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID());
        firstItem.setPoints(1111500000.0);
        ...
        final RankingByUserDO[] items = new RankingByUserDO[SAMPLE_DATA_ENTRIES_PER_INSERT-1];
        for (int count = 0; count < SAMPLE_DATA_ENTRIES_PER_INSERT-1; count++) {
            final RankingByUserDO item = new RankingByUserDO();
            item.setUserId(AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID());
            item.setPoints(DemoSampleDataGenerator.getRandomSampleNumber());
    ...
    public void removeSampleData() throws AmazonClientException {
        ...
        final PaginatedQueryList<RankingByUserDO> results = mapper.query(RankingByUserDO.class, queryExpression);

        Iterator<RankingByUserDO> resultsIterator = results.iterator();
        ...
        final List<RankingByUserDO> batchOfItems = new LinkedList<RankingByUserDO>();
